		...
		if st.sidebar.checkbox("Login"):
			...
			if result:
				...
				if task == "Add Post":
					...
					'https://share.streamlit.io/takanorinakaya/texttospeech-003/main/app.py'

					st.write('リアルタイム動画解析')
					'https://share.streamlit.io/whitphx/streamlit-webrtc-example/main/app.py'

					st.write('ダッシュボード')
					'https://share.streamlit.io/takanorinakaya/interactive-dashboard-01/main/db_app.py'

					st.write('機械学習アプリ')
					'https://share.streamlit.io/kunishou/streamlit_tools/web_tools.py'

					st.write('画風変換アプリ')
					'https://mimic-fnst.herokuapp.com/'
